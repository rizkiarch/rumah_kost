...
<body style="background: #214a80;">
    <div class="login-dark" style="height: 695px;">
        <form method="POST" action="{{ route('login') }}">
            ...
            <p class="kost text-left font-semibold text-gray-800 dark:text-gray-200 leading-tight">Selamat Datang di</p>
            <h4 class="rumah text-center font-semibold text-gray-800 dark:text-gray-200 leading-tight">Rumah
                <span class="kost">Kost</span>
            </h4>
